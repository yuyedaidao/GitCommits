...
public struct Flow<RefreshBinding, Data, ItemView: View>: View {
  let mode: Mode
...
public extension Flow where RefreshBinding == Never? {
    init(mode: Mode,
         items: [Data],
         itemSpacing: CGFloat = flowLayoutDefaultItemSpacing,
         @ViewBuilder viewMapping: @escaping (Data) -> ItemView) {
